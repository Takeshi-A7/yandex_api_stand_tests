...
# Тест №2. Параметр firstName состоит из 15 символов
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Aaaaaaaaaaaaaaa")

# Подготовка к 3-му тесту
...
# Тест №3. Параметр firstName состоит из 1 символов
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")
# Тест №4. Параметр firstName состоит из 16 символов
def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("Aaaaaaaaaaaaaaaa")
# Тест №5. Параметр firstName разрешены английские буквы
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")
# Тест №6. Параметр firstName разрешены русские буквы
def test_create_user_russian_letter_in_first_name_get_success_response():
    positive_assert("Мария")
# Тест №7. Параметр firstName запрещены пробелы
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и КО")
# Тест №8. Параметр firstName запрещены спецсимволы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")
# Тест №9. Параметр firstName запрещены цифры
